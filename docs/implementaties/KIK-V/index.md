...
- Applicatie:
    ...
    - **laag 3 | Datastation** bevat de data en metadata van de data in RDF formaat en is via het beveiligde NUTS-netwerk te benaderen middels een SPARQL query API.
- Infrastructuur:
