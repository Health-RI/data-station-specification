# Specification of requirements for secure processing environments

The list of requirements from TEHDAS2 consultation _7.4 Draft technical, functional and security specifications of Secure Processing Environments | Appendix B_ are listed below.
