# 2.0. Perspectief: proces
## 2.0.1. Het proces van secundair gebruik van data _system of interest_
...
## 2.0.2. Het proces van secundair gebruik vanuit het perspectief van de data gebruiker
...
###  2.0.2.1. Data zoeken en vinden (_data discovery_)
...
### 2.0.2.2. Data aanvragen (_data access_)
...
### 2.0.2.3. Data klaarzetten voor verwerking (_data preparation_)
...
### 2.0.2.4. Data analyseren (_use of data_)
...
### 2.0.2.5. Resultaten publiceren (_finalisation_)
